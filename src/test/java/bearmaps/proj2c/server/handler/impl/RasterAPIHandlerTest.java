...
public class RasterAPIHandlerTest {
    ...
    private static final String PARAMS_FILE = "proj2c_test_inputs/raster_params.txt";
    private static final String RESULTS_FILE = "proj2c_test_inputs/raster_results.txt";
    ...
    private List<Map<String, Double>> paramsFromFile() throws Exception {
        List<String> lines = Files.readAllLines(Paths.get(this.getClass().getClassLoader().getResource(PARAMS_FILE).toURI()), Charset.defaultCharset());
