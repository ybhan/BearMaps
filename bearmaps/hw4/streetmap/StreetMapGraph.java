...
public class StreetMapGraph implements AStarGraph<Long> {
     ...
     **/
    @Override
    public Set<WeightedEdge<Long>> neighbors(Long v) {
...
//            saxParser.parse(inputStream, gbh);
    ...
    public boolean equals(Object o) {
        ...
        for (long id : myVertices) {
            ...
            Set<WeightedEdge<Long>> myNeighbors = neighbors(id);
            Set<WeightedEdge<Long>> otherGraphNeighbors = otherGraph.neighbors(id);
