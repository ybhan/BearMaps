...
public class DirectionsTest {
    private static final String PATHS_FILE = "proj2c_test_inputs/path_results.txt";
    private static final String RESULTS_FILE = "proj2c_test_inputs/directions_results.txt";
    ...
    private List<List<Long>> pathsFromFile() throws Exception {
        List<String> lines = Files.readAllLines(Paths.get(this.getClass().getClassLoader().getResource(PATHS_FILE).toURI()), Charset.defaultCharset());
    ...
    private List<List<Router.NavigationDirection>> resultsFromFile() throws Exception {
        List<String> lines = Files.readAllLines(Paths.get(this.getClass().getClassLoader().getResource(RESULTS_FILE).toURI()), Charset.defaultCharset());
